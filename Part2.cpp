...
void runPart2(){
  ...
  // generate a random list 10 times and test it against all algorithms in order
  for( int i =0 ; i < 10 ; i += 1){
    ...
    for(callback_function callbackFunction:callbacks){
      ...
      // every iteration will change algorithm and use the SAME list of ordres
      ...
      measureExecutionTime(callbackFunction);
    }
  }
};